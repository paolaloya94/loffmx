 ...
 */
$source = $fit_bg_text = $text = $link = $google_fonts = $font_container = $el_class = $css = $font_container_data = $google_fonts_data = '';
...
if($atts['fit_bg_text'] == 1) {
	$css_class .= " fit_bg_text ";
	if(in_array("text-align: center", $styles)){
		$css_class .= " fit_bg_center";	
	}
...
if(array_key_exists('fit_bg_text', $atts) && $atts['fit_bg_text'] == "fit_yes") {
